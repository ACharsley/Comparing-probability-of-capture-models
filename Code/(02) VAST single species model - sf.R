...
sf_path <- file.path(output_path, "VAST_sf")
...
table(NZFFD.REC2.Diad.EF$year, NZFFD.REC2.Diad.EF[,"angaus"])
...
#Region
Region="Other" #Region = "Other" in master's analysis
